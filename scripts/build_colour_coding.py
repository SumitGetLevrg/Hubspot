...
def info(i):
    ...
    elif not ds and ls.lower() in BROWN: col='Brown'  # utm_campaign and tasks ignored for Brown
...
L=[['Colour','Rule applied'],
 ...
 ['Brown','utm_campaign ignored (any value, including blank) AND upcoming/previous tasks ignored (may be none) AND deal stage blank AND lead status in {Not a Fit, Cancelled, Unqualified, Attempted to Contact, Bad Timing, No Response, No Show, Cold Lead, Long Term Nurture, Invalid Contact Info, Do Not Contact}'],
